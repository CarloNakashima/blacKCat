...
public class Proyecto_Software {
    ...
    {
        File archivo = new File("C:\\Users\\Adlai\\Desktop\\Proyecto.txt");
    ...
    int C=0;
        ...
        while((linea = br.readLine()) != null)
        {
           ...
           linea13=linea12.replace("�Ensenada�", "");
    ...
    public static void Excel()
    {
       ...
       fileout.close();
           ...
           Logger.getLogger(Proyecto_Software.class.getName()).log(Level.SEVERE,null,ex);
